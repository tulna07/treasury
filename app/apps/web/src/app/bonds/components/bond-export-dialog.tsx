...
import { useExportBondDeals } from "@/hooks/use-bonds";
...
export function BondExportDialog() {
  const { t } = useTranslation();
  const ability = useAbility();
  const exportMutation = useExportBondDeals();
  ...
  if (!ability.can("export", "GTCGTransaction")) return null;
  ...
  function handleSubmit() {
    ...
    exportMutation.mutate(
      ...
      {
        onSuccess: () => {
          toast.success(t("bond.export.success"));
          setOpen(false);
          handleReset();
        },
        onError: (err) => {
