...
interface FxAttachmentUploadProps {
  dealId: string;
  dealModule?: string;
  onUploaded?: () => void;
}

export function FxAttachmentUpload({
  dealId,
  dealModule = "FX",
  onUploaded,
}: FxAttachmentUploadProps) {
  ...
  const validateFiles = useCallback(
    (files: File[]): string | null => {
      ...
      for (const file of files) {
        ...
        // Check extension as fallback for content type detection issues
  ...
  const handleUpload = useCallback(() => {
    ...
    uploadMutation.mutate(
      { dealModule, dealId, files: selectedFiles },
      {
        onSuccess: () => {
  ...
  }, [selectedFiles, dealModule, dealId, uploadMutation, t, onUploaded]);
