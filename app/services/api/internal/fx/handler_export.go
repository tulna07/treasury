...
// ExportHandler handles FX export HTTP requests.
...
// NewExportHandler creates a new FX export handler.
...
// ExportDeals handles POST /fx/deals/export
func (h *ExportHandler) ExportDeals(w http.ResponseWriter, r *http.Request) {
	...
	builder := NewFXReportBuilder(deals)
...
// validatePassword checks password strength: min 8 chars, upper + lower + digit.
